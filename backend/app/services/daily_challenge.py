...
CHALLENGES: tuple[DailyChallenge, ...] = (
    ...
    # ── 19×19 endgame ─────────────────────────────────────────────────
    # 후반전 진행된 국면. 4 귀 정착 + 변·중앙 윤곽 + 구체적 끝내기 자리.
    # KataGo 가 분석해 큰 끝내기 자리와 작은 자리의 가치 차이를 채점한다.
    _ch("ch-19-en-0", size=19, to_move="B", difficulty="easy", topic="endgame",
        setup=(
            # 좌상귀 — 흑 정착
            ("B", "D17"), ("B", "D16"), ("B", "E16"), ("B", "F16"),
            ("B", "C14"), ("B", "D14"),
            # 우상귀 — 백 정착, 흑 외목 침입 흔적
            ("W", "P17"), ("W", "Q17"), ("W", "R17"), ("W", "Q16"),
            ("W", "P15"), ("B", "O16"), ("B", "O17"),
            # 우하귀 — 흑 정착
            ("B", "Q4"), ("B", "Q5"), ("B", "P4"), ("B", "R5"), ("B", "P5"),
            # 좌하귀 — 백 정착
            ("W", "C4"), ("W", "D4"), ("W", "D3"), ("W", "E4"), ("W", "C5"),
            # 변·중앙
            ("B", "K10"), ("B", "K17"), ("B", "K3"),
            ("W", "Q10"), ("W", "C10"),
            # 우변 1·2선 끝내기 침투 자리
    ...
    _ch("ch-19-en-m", size=19, to_move="W", difficulty="medium", topic="endgame",
        setup=(
            # 좌상귀 — 흑 정착
            ("B", "C17"), ("B", "D17"), ("B", "D16"), ("B", "E16"),
            ("B", "F16"), ("B", "C15"),
            # 우상귀 — 백 정착
            ("W", "Q17"), ("W", "Q16"), ("W", "P16"), ("W", "P17"),
            ("W", "R15"), ("W", "O17"),
            # 좌하귀 — 백 정착
            ("W", "C4"), ("W", "D4"), ("W", "D3"), ("W", "E4"), ("W", "F3"),
            # 우하귀 — 흑 정착
            ("B", "Q4"), ("B", "P4"), ("B", "R5"), ("B", "Q3"), ("B", "P5"),
            # 변·중앙 윤곽
            ("B", "K17"), ("B", "K10"), ("B", "K3"),
            ("W", "Q10"), ("W", "C10"),
            # 좌하 2선 — 백 차례, 원숭이 점프 가능한 끝내기 모양
            ("W", "B5"), ("B", "B6"), ("B", "C6"), ("B", "D5"), ("B", "E5"),
        )),
    _ch("ch-19-en-1", size=19, to_move="B", difficulty="hard", topic="endgame",
        setup=(
            # 4 귀 모두 정착, 변에 큰 끝내기들이 남은 후반전
            # 좌상귀 — 흑 정착
            ("B", "D17"), ("B", "D16"), ("B", "E16"), ("B", "C16"),
            ("B", "C14"), ("B", "F16"),
            # 우상귀 — 백 정착
            ("W", "P17"), ("W", "Q17"), ("W", "R17"), ("W", "Q16"),
            ("W", "Q14"), ("W", "O17"),
            ...
            ("B", "E4"), ("B", "B6"),
            # 우하귀 — 백 정착
            ("W", "Q4"), ("W", "P4"), ("W", "Q5"), ("W", "R5"), ("W", "P3"),
            # 변·중앙
            ("B", "K17"), ("B", "K3"), ("B", "K10"),
            ("W", "Q10"), ("W", "C10"),
            # 양쪽 변 큰 끝내기 후보 — 흑 차례, 선·후수 가치 비교
            ("W", "F4"), ("B", "F5"),
            ("B", "L17"), ("W", "M17"),
            ("W", "S15"), ("B", "R15"),
        )),
