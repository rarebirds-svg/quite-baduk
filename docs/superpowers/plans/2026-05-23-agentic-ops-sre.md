...
- [ ] **Step 1: `docs/ops/runbooks/backup-verify.md` 작성**
...
- [ ] **Step 3: `case` 분기에 `restart/prod` 추가**
...
- [ ] **Step 1: `docs/ops/runbooks/deploy.md` 작성**
...
- [ ] **Step 1: `docs/ops/autonomy-policy.md`에 화이트리스트 절 추가**
...
- [ ] **Step 2: `docs/ops/runbooks/incident.md` 작성**
...
- [ ] **Step 2: `dashboard.md`에 백업 상태 행 추가**
...
- [ ] **Step 1: staging 빌드+테스트 (deploy.md 1단계)**
